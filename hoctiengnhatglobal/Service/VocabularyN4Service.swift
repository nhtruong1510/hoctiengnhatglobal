...
class VocabularyN4Service: NSObject {
    static let shared: VocabularyN4Service = VocabularyN4Service()
    ...
    func loadInit(linkPath:String){
        ...
        do{
            dbPath = try fileManager
                ...
                .appendingPathComponent("TuVungJLPTN4_15.sqlite")
                .path
            if !fileManager.fileExists(atPath: dbPath) {
                dbResourcePath = Bundle.main.path(forResource: "TuVungJLPTN4_15", ofType: "sqlite")!
