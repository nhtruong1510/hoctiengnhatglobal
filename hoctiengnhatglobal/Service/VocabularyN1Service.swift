...
class VocabularyN1Service: NSObject {
    static let shared: VocabularyN1Service = VocabularyN1Service()
    ...
    func loadInit(linkPath:String){
        ...
        do{
            dbPath = try fileManager
                ...
                .appendingPathComponent("TuVungJLPTN1_10.sqlite")
                .path
            if !fileManager.fileExists(atPath: dbPath) {
                dbResourcePath = Bundle.main.path(forResource: "TuVungJLPTN1_10", ofType: "sqlite")!
