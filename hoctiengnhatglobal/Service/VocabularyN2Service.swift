...
class VocabularyN2Service: NSObject {
    static let shared: VocabularyN2Service = VocabularyN2Service()
    ...
    func loadInit(linkPath:String){
        ...
        do{
            dbPath = try fileManager
                ...
                .appendingPathComponent("TuVungJLPTN2_20.sqlite")
                .path
            if !fileManager.fileExists(atPath: dbPath) {
                dbResourcePath = Bundle.main.path(forResource: "TuVungJLPTN2_20", ofType: "sqlite")!
