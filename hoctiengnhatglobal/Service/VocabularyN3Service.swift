...
class VocabularyN3Service: NSObject {
    static let shared: VocabularyN3Service = VocabularyN3Service()
    ...
    func loadInit(linkPath:String){
        ...
        do{
            dbPath = try fileManager
                ...
                .appendingPathComponent("TuVungJLPTN3_18.sqlite")
                .path
            if !fileManager.fileExists(atPath: dbPath) {
                dbResourcePath = Bundle.main.path(forResource: "TuVungJLPTN3_18", ofType: "sqlite")!
